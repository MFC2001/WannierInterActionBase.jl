...
export AbstractLattice, Lattice, basisvectors
...
Base.:*(lattice::AbstractLattice, reduced::AbstractVector) = parent(lattice) * reduced

# You need this to let the broadcasting work.
Base.:\(lattice::Lattice, cartesian::CartesianCoordinates) = ReducedCoordinates(parent(lattice) \ cartesian)
Base.:\(lattice::AbstractLattice, cartesian::AbstractVector) = parent(lattice) \ cartesian
