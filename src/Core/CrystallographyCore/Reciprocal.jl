...
Base.:*(lattice::ReciprocalLattice, reduced::AbstractVector) = parent(lattice) * reduced

# You need this to let the broadcasting work.
Base.:\(lattice::ReciprocalLattice, cartesian::AbstractVector) = parent(lattice) \ cartesian
